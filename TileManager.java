...
//			tile[3].collision=true;
			...
			tile[64] = new Tile();
			tile[64].imgae = ImageIO.read(getClass().getResourceAsStream("/tiles_Nha/Chest_05.png"));
...
//			tile[135].collision=true;
	...
	public void setup(int index, String imageName, boolean collision) {
		...
		try {
			tile[index] = new Tile();
			tile[index].image = ImageIO.read(getClass().getResourceAsStream("/tiles_Nha/" + imageName + ".png"));
