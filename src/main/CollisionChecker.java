...
//						System.out.println("Hương đi lên đang va chạm với cái gì đó");
				...
				case "down":
					entity.solidArea.y += entity.speed;
					if(entity.solidArea.intersects(gp.obj[i].solidArea)) {
//						System.out.println("Hương đi xuống đang va chạm với cái gì đó");
						if(gp.obj[i].collision == true) {
							entity.collisionOn = true;
						}
						if (player == true) {
				...
				case "left":
					...
					if(entity.solidArea.intersects(gp.obj[i].solidArea)) {
//						System.out.println("Hương đi bên trái đang va chạm với cái gì đó chạm với cái gì đó");
						if(gp.obj[i].collision == true) {
							entity.collisionOn = true;
						}
						if (player == true) {
				...
				case "right":
					entity.solidArea.x += entity.speed;
					if(entity.solidArea.intersects(gp.obj[i].solidArea)) {
//						System.out.println("Hương đi bên phải đang va chạm với cái gì đó Va chạm với cái gì đó");
						if(gp.obj[i].collision == true) {
							entity.collisionOn = true;
						}
						if (player == true) {
